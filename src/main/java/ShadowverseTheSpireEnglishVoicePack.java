...
public class ShadowverseTheSpireEnglishVoicePack implements PostInitializeSubscriber {
    ...
    public void receivePostInitialize() {
        ...
        reflectedMap.put("ImpiousBishop", new Sfx(voicePath+"ImpiousBishop.mp3"));
        reflectedMap.put("ImpiousBishop_Acc", new Sfx(voicePath+"ImpiousBishop_Acc.mp3"));
        reflectedMap.put("Magachiyo", new Sfx(voicePath+"Magachiyo.mp3"));
        reflectedMap.put("LeafshadeAssassin", new Sfx(voicePath+"LeafshadeAssassin.mp3"));
        reflectedMap.put("LeafshadeAssassinPower", new Sfx(voicePath+"LeafshadeAssassinPower.mp3"));
        reflectedMap.put("VerdantLieutenant", new Sfx(voicePath+"VerdantLieutenant.mp3"));
        reflectedMap.put("VerdantLieutenantPower", new Sfx(voicePath+"VerdantLieutenantPower.mp3"));
        reflectedMap.put("BuddingInitiate", new Sfx(voicePath+"BuddingInitiate.mp3"));
        reflectedMap.put("Wimael", new Sfx(voicePath+"Wimael.mp3"));
        reflectedMap.put("BenevolentElf", new Sfx(voicePath+"BenevolentElf.mp3"));
        reflectedMap.put("BenevolentElfPower", new Sfx(voicePath+"BenevolentElfPower.mp3"));
        reflectedMap.put("Simael", new Sfx(voicePath+"Simael.mp3"));
        reflectedMap.put("BladeRain", new Sfx(voicePath+"BladeRain.mp3"));
        reflectedMap.put("AstrologicalSorcerer", new Sfx(voicePath+"AstrologicalSorcerer.mp3"));
        reflectedMap.put("VolunteerTestSubject", new Sfx(voicePath+"VolunteerTestSubject.mp3"));
        reflectedMap.put("DevotedResearcher", new Sfx(voicePath+"DevotedResearcher.mp3"));
        reflectedMap.put("DevotedResearcher_EH", new Sfx(voicePath+"DevotedResearcher_EH.mp3"));
        reflectedMap.put("ObsessiveScholar", new Sfx(voicePath+"ObsessiveScholar.mp3"));
        reflectedMap.put("Sephie", new Sfx(voicePath+"Sephie.mp3"));
        reflectedMap.put("Istyndet", new Sfx(voicePath+"Istyndet.mp3"));
        reflectedMap.put("Myroel", new Sfx(voicePath+"Myroel.mp3"));
        reflectedMap.put("GhastlyBanishment", new Sfx(voicePath+"GhastlyBanishment.mp3"));
        reflectedMap.put("GhastlyBanishment_EH", new Sfx(voicePath+"GhastlyBanishment_EH.mp3"));
        reflectedMap.put("Garodeth", new Sfx(voicePath+"Garodeth.mp3"));
        reflectedMap.put("ViciousBlitzer", new Sfx(voicePath+"ViciousBlitzer.mp3"));
        reflectedMap.put("SteamrollingTank", new Sfx(voicePath+"SteamrollingTank.mp3"));
        reflectedMap.put("SteamrollingTankPower", new Sfx(voicePath+"SteamrollingTankPower.mp3"));
        reflectedMap.put("RagingCommander", new Sfx(voicePath+"RagingCommander.mp3"));
        reflectedMap.put("RagingCommanderPower", new Sfx(voicePath+"RagingCommanderPower.mp3"));
        reflectedMap.put("Genomuel", new Sfx(voicePath+"Genomuel.mp3"));
        reflectedMap.put("Erralde", new Sfx(voicePath+"Erralde.mp3"));
        reflectedMap.put("ExecutorOfTheOath ", new Sfx(voicePath+"ExecutorOfTheOath .mp3"));
        reflectedMap.put("AgentOfTheCommandments", new Sfx(voicePath+"AgentOfTheCommandments.mp3"));
        reflectedMap.put("AgentOfTheCommandmentsPower", new Sfx(voicePath+"AgentOfTheCommandmentsPower.mp3"));
        reflectedMap.put("Uneriel", new Sfx(voicePath+"Uneriel.mp3"));
        reflectedMap.put("UnerielPower", new Sfx(voicePath+"UnerielPower.mp3"));
        reflectedMap.put("UnerielPower2", new Sfx(voicePath+"UnerielPower2.mp3"));
        reflectedMap.put("SkullFane2", new Sfx(voicePath+"SkullFane2.mp3"));
        reflectedMap.put("SkullFane2_Acc", new Sfx(voicePath+"SkullFane2_Acc.mp3"));
        reflectedMap.put("Cutthroat", new Sfx(voicePath+"Cutthroat.mp3"));
        reflectedMap.put("Cutthroat_EH", new Sfx(voicePath+"Cutthroat_EH.mp3"));
        reflectedMap.put("Cutthroat_EXEH", new Sfx(voicePath+"Cutthroat_EXEH.mp3"));
        reflectedMap.put("IronforgedRightHand", new Sfx(voicePath+"IronforgedRightHand.mp3"));
        reflectedMap.put("IronforgedRightHand_EH", new Sfx(voicePath+"IronforgedRightHand_EH.mp3"));
        reflectedMap.put("IronforgedRightHand_EXEH", new Sfx(voicePath+"IronforgedRightHand_EXEH.mp3"));
        reflectedMap.put("SmeltworkBodyguard", new Sfx(voicePath+"SmeltworkBodyguard.mp3"));
        reflectedMap.put("SmeltworkBodyguard_EH", new Sfx(voicePath+"SmeltworkBodyguard_EH.mp3"));
        reflectedMap.put("BlackrustUnderling", new Sfx(voicePath+"BlackrustUnderling.mp3"));
        reflectedMap.put("BlackrustUnderling_EH", new Sfx(voicePath+"BlackrustUnderling_EH.mp3"));
        reflectedMap.put("BlackrustUnderling_EXEH", new Sfx(voicePath+"BlackrustUnderling_EXEH.mp3"));
        reflectedMap.put("Kyrzael", new Sfx(voicePath+"Kyrzael.mp3"));
        reflectedMap.put("Karula_EH", new Sfx(voicePath+"Karula_EH.mp3"));
        reflectedMap.put("NightVampire_L", new Sfx(voicePath+"NightVampire_L.mp3"));
        reflectedMap.put("Cutthroat_L", new Sfx(voicePath+"Cutthroat_L.mp3"));
        reflectedMap.put("Cutthroat_L_EH", new Sfx(voicePath+"Cutthroat_L_EH.mp3"));
        reflectedMap.put("Cutthroat_L_EXEH", new Sfx(voicePath+"Cutthroat_L_EXEH.mp3"));
        ...
        reflectedMap.put("Taketsumi_Start", new Sfx(voicePath+"Taketsumi_Start.mp3"));
        ...
        reflectedMap.put("TidalGunner", new Sfx(voicePath+"TidalGunner.mp3"));
        reflectedMap.put("TidalGunnerPower", new Sfx(voicePath+"TidalGunnerPower.mp3"));
        reflectedMap.put("DeepSeaScout", new Sfx(voicePath+"DeepSeaScout.mp3"));
        reflectedMap.put("DeepSeaScoutPower", new Sfx(voicePath+"DeepSeaScoutPower.mp3"));
        reflectedMap.put("StormWrackedFirstMate", new Sfx(voicePath+"StormWrackedFirstMate.mp3"));
        reflectedMap.put("StormWrackedFirstMatePower", new Sfx(voicePath+"StormWrackedFirstMatePower.mp3"));
        reflectedMap.put("Barbaros", new Sfx(voicePath+"Barbaros.mp3"));
        reflectedMap.put("Barbaros_Eh", new Sfx(voicePath+"Barbaros_Eh.mp3"));
        reflectedMap.put("Radiel", new Sfx(voicePath+"Radiel.mp3"));
        reflectedMap.put("IronwroughtDefender", new Sfx(voicePath+"IronwroughtDefender.mp3"));
        reflectedMap.put("Windslasher", new Sfx(voicePath+"Windslasher.mp3"));
        reflectedMap.put("GeneralMaximus", new Sfx(voicePath+"GeneralMaximus.mp3"));
        reflectedMap.put("OliviaSylvia", new Sfx(voicePath+"OliviaSylvia.mp3"));
    }
